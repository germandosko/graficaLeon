	...
	<body>	
		<div id="header">
			...
			<div id="content">
				...
				<span class="title">Administracion de Precios:</span>
				<ul class="menuAdmin">
					<li><a href="objectsPrice.php?objectName=paper">Papeles</a></li>
					<li><a href="objectsPrice.php?objectName=machine">Maquinas</a></li>
					<li><a href="objectsPrice.php?objectName=design">Dise&ntilde;os</a></li>
					<li><a href="objectsPrice.php?objectName=cut">Cortes</a></li>
					<li><a href="objectsPrice.php?objectName=termination">Terminaciones</a></li>
				</ul>	
			</div>
		</div>		
		<div class="clearfix"></div>
