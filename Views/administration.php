		...
		<div id="header">
			...
			<div id="content">
				...
				<ul class="menuAdmin">
					...
					<li><a href="orders.php">Ordenes de Pedido</a></li>
					<li><a href="boxes.php">Caja</a></li>
					<li><a href="liabilities.php">Deudores</a></li>
					<li><a href="newPriceSelection.php">Calculo de Precio</a></li>
					<li><a href="administrationPrice.php">Administracion Precios</a></li>
					<li><a href="imagesGallery.php">Cargar Galeria de Imagenes</a></li>
				</ul>	
			</div>
		</div>		
		<div class="clearfix"></div>
