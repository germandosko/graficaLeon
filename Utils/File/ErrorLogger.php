...
class ErrorLogger
{
	...
	/**
	 *	The current Dto Bundle partner
	 */
	private $partner;
	...
	private function setLogFileName()
	{
		switch ($this->processType) {
			case Type::MERGE:
				$this->logFileName = date("Y-m-d").'_MERGE'.LOGS_FILE_EXTENSION;
				break;
			case Type::CONVERSION:
				$this->logFileName = date("Y-m-d").'_CONVERSION'.LOGS_FILE_EXTENSION;
				break;
			case Type::TRANSPORTER:
				$this->logFileName = date("Y-m-d").'_TRANSPORTER'.LOGS_FILE_EXTENSION;
				break;
			case Type::FRONTEND:
			case Type::UNDEFINED:
			default:
				$this->logFileName = date("Y-m-d").'_UNDEFINED_PROCESS_TYPE'.LOGS_FILE_EXTENSION;
				break;
		}
	}
	...
	{
		if($addsTimePrefix){
			$logLine = date("Y-m-d H:m:s") . "\t" . $logLine . "\n";
		} else {
			$logLine .= "\n";
		}
